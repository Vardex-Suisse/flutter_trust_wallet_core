...
abstract class TWHDWallet {
  ...
  static late final _TWHDWalletCreate_ptr =
      _lookup<NativeFunction<_c_TWHDWalletCreate>>('TWHDWalletCreate');
  static late final _dart_TWHDWalletCreate _TWHDWalletCreate =
  ...
  static late final _TWHDWalletCreateWithMnemonic_ptr =
      _lookup<NativeFunction<_c_TWHDWalletCreateWithMnemonic>>(
          'TWHDWalletCreateWithMnemonic');
  static late final _dart_TWHDWalletCreateWithMnemonic
  ...
  static late final _TWHDWalletCreateWithEntropy_ptr =
      _lookup<NativeFunction<_c_TWHDWalletCreateWithEntropy>>(
          'TWHDWalletCreateWithEntropy');
  static late final _dart_TWHDWalletCreateWithEntropy
      _TWHDWalletCreateWithEntropy = _TWHDWalletCreateWithEntropy_ptr
          .asFunction<_dart_TWHDWalletCreateWithEntropy>();
  ...
  static late final _TWHDWalletDelete_ptr =
      _lookup<NativeFunction<_c_TWHDWalletDelete>>('TWHDWalletDelete');
  static late final _dart_TWHDWalletDelete _TWHDWalletDelete =
  ...
  static late final _TWHDWalletSeed_ptr =
      _lookup<NativeFunction<_c_TWHDWalletSeed>>('TWHDWalletSeed');
  static late final _dart_TWHDWalletSeed _TWHDWalletSeed =
  ...
  static late final _TWHDWalletMnemonic_ptr =
      _lookup<NativeFunction<_c_TWHDWalletMnemonic>>('TWHDWalletMnemonic');
  static late final _dart_TWHDWalletMnemonic _TWHDWalletMnemonic =
  ...
  static late final _TWHDWalletGetMasterKey_ptr =
      _lookup<NativeFunction<_c_TWHDWalletGetMasterKey>>(
          'TWHDWalletGetMasterKey');
  static late final _dart_TWHDWalletGetMasterKey _TWHDWalletGetMasterKey =
  ...
  static late final _TWHDWalletGetKeyForCoin_ptr =
      _lookup<NativeFunction<_c_TWHDWalletGetKeyForCoin>>(
          'TWHDWalletGetKeyForCoin');
  static late final _dart_TWHDWalletGetKeyForCoin _TWHDWalletGetKeyForCoin =
  ...
  static late final _TWHDWalletGetAddressForCoin_ptr =
      _lookup<NativeFunction<_c_TWHDWalletGetAddressForCoin>>(
          'TWHDWalletGetAddressForCoin');
  static late final _dart_TWHDWalletGetAddressForCoin
      _TWHDWalletGetAddressForCoin = _TWHDWalletGetAddressForCoin_ptr
          .asFunction<_dart_TWHDWalletGetAddressForCoin>();
  ...
  static late final _TWHDWalletGetKey_ptr =
      _lookup<NativeFunction<_c_TWHDWalletGetKey>>('TWHDWalletGetKey');
  static late final _dart_TWHDWalletGetKey _TWHDWalletGetKey =
  ...
  static late final _TWHDWalletGetDerivedKey_ptr =
      _lookup<NativeFunction<_c_TWHDWalletGetDerivedKey>>(
          'TWHDWalletGetDerivedKey');
  static late final _dart_TWHDWalletGetDerivedKey _TWHDWalletGetDerivedKey =
  ...
  static late final _TWHDWalletGetExtendedPublicKey_ptr =
      _lookup<NativeFunction<_c_TWHDWalletGetExtendedPublicKey>>(
          'TWHDWalletGetExtendedPublicKey');
  static late final _dart_TWHDWalletGetExtendedPublicKey
  ...
  static late final _TWHDWalletGetPublicKeyFromExtended_ptr =
      _lookup<NativeFunction<_c_TWHDWalletGetPublicKeyFromExtended>>(
          'TWHDWalletGetPublicKeyFromExtended');
  static late final _dart_TWHDWalletGetPublicKeyFromExtended
