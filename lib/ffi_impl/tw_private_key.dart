...
abstract class TWPrivateKey {
  ...
  static late final _TWPrivateKeyCreate_ptr =
      _lookup<NativeFunction<_c_TWPrivateKeyCreate>>('TWPrivateKeyCreate');
  static late final _dart_TWPrivateKeyCreate _TWPrivateKeyCreate =
  ...
  static late final _TWPrivateKeyCreateWithData_ptr =
      _lookup<NativeFunction<_c_TWPrivateKeyCreateWithData>>(
          'TWPrivateKeyCreateWithData');
  static late final _dart_TWPrivateKeyCreateWithData
      _TWPrivateKeyCreateWithData = _TWPrivateKeyCreateWithData_ptr.asFunction<
  ...
  static late final _TWPrivateKeyCreateCopy_ptr =
      _lookup<NativeFunction<_c_TWPrivateKeyCreateCopy>>(
          'TWPrivateKeyCreateCopy');
  static late final _dart_TWPrivateKeyCreateCopy _TWPrivateKeyCreateCopy =
  ...
  static late final _TWPrivateKeyDelete_ptr =
      _lookup<NativeFunction<_c_TWPrivateKeyDelete>>('TWPrivateKeyDelete');
  static late final _dart_TWPrivateKeyDelete _TWPrivateKeyDelete =
  ...
  static late final _TWPrivateKeyIsValid_ptr =
      _lookup<NativeFunction<_c_TWPrivateKeyIsValid>>('TWPrivateKeyIsValid');
  static late final _dart_TWPrivateKeyIsValid _TWPrivateKeyIsValid =
  ...
  static late final _TWPrivateKeyData_ptr =
      _lookup<NativeFunction<_c_TWPrivateKeyData>>('TWPrivateKeyData');
  static late final _dart_TWPrivateKeyData _TWPrivateKeyData =
  ...
  static late final _TWPrivateKeyGetPublicKeySecp256k1_ptr =
      _lookup<NativeFunction<_c_TWPrivateKeyGetPublicKeySecp256k1>>(
          'TWPrivateKeyGetPublicKeySecp256k1');
  static late final _dart_TWPrivateKeyGetPublicKeySecp256k1
  ...
  late final _TWPrivateKeyGetPublicKeyNist256p1_ptr =
      _lookup<NativeFunction<_c_TWPrivateKeyGetPublicKeyNist256p1>>(
  ...
  static late final _TWPrivateKeyGetPublicKeyEd25519_ptr =
      _lookup<NativeFunction<_c_TWPrivateKeyGetPublicKeyEd25519>>(
          'TWPrivateKeyGetPublicKeyEd25519');
  static late final _dart_TWPrivateKeyGetPublicKeyEd25519
  ...
  late final _TWPrivateKeyGetPublicKeyEd25519Blake2b_ptr =
      _lookup<NativeFunction<_c_TWPrivateKeyGetPublicKeyEd25519Blake2b>>(
  ...
  late final _TWPrivateKeyGetPublicKeyEd25519Extended_ptr =
      _lookup<NativeFunction<_c_TWPrivateKeyGetPublicKeyEd25519Extended>>(
  ...
  late final _TWPrivateKeyGetPublicKeyCurve25519_ptr =
      _lookup<NativeFunction<_c_TWPrivateKeyGetPublicKeyCurve25519>>(
  ...
  late final _TWPrivateKeyGetSharedKey_ptr =
      _lookup<NativeFunction<_c_TWPrivateKeyGetSharedKey>>(
  ...
  late final _TWPrivateKeySign_ptr =
      _lookup<NativeFunction<_c_TWPrivateKeySign>>('TWPrivateKeySign');
  ...
  late final _TWPrivateKeySignAsDER_ptr =
      _lookup<NativeFunction<_c_TWPrivateKeySignAsDER>>(
  ...
  late final _TWPrivateKeySignSchnorr_ptr =
      _lookup<NativeFunction<_c_TWPrivateKeySignSchnorr>>(
